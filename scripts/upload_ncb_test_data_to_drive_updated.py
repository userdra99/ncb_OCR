...
def upload_to_drive(file_path: Path, folder_id: str) -> str:
    ...
    try:
        ...
        # ✅ UPDATED: Add supportsAllDrives=True for Shared Drive support
        file = service.files().create(
            body=file_metadata,
            media_body=media,
            fields='id, name, webViewLink',
            supportsAllDrives=True  # 🔑 CRITICAL: Required for Google Shared Drives
        ).execute()
...
def main():
    ...
    # Print results
    print("\n📁 Uploaded NCB Test Files to Shared Drive:")
    print("="*60)
    ...
    print(f"\n📝 Upload summary: {summary_path}")
    print("\n💡 Tip: View files at https://drive.google.com/drive/shared-drives")
